...
'''
This is the more complete, state-of-the-art, model for Boston and Cambridge 
(Massachussetts). It considers communities within neighborhood, for a grand total
of 23 neighborhoods, each of which has 17 communities.

To run this code, N should be at least 10k. Possibly more (I tried with 100k)
'''
